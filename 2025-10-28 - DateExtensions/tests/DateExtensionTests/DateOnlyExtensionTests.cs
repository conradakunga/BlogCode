...
public class DateOnlyExtensionTests
{
    ...
    public void StartOfQuarterTests(int testMonth, int testDay, int actualMonth, int actualDay)
    {
        ...
        testDate.StartOfQuarter.Should().Be(new DateOnly(2025, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(2025, testMonth, testDay);
        testDate.EndOfQuarter.Should().Be(new DateOnly(2025, actualMonth, actualDay));
    }
        ...
        int actualDay)
    {
        ...
        testDate.EndOfPreviousQuarter.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.StartOfPreviousQuarter.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.StartOfNextQuarter.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.EndOfNextQuarter.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.StartOfCurrentYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.EndOfCurrentYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.StartOfPreviousYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.EndOfPreviousYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.StartOfNextYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
    ...
    {
        var testDate = new DateOnly(testYear, testMonth, testDay);
        testDate.EndOfNextYear.Should().Be(new DateOnly(actualYear, actualMonth, actualDay));
    }
}